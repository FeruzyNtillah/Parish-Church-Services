    ...
    <div className="p-6 max-w-7xl mx-auto">
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-gray-600 dark:text-gray-400 mt-1">Manage and view all church families</p>
        </div>
        <button
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm font-medium text-gray-600 dark:text-gray-400">Total Families</p>
              <p className="text-2xl font-bold text-gray-900 dark:text-white mt-1">{statistics.totalFamilies}</p>
            </div>
        ...
        <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-gray-900 dark:text-white mt-1">{statistics.totalMembers}</p>
            </div>
        ...
        <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm font-medium text-gray-600 dark:text-gray-400">Avg Members/Family</p>
              <p className="text-2xl font-bold text-gray-900 dark:text-white mt-1">{statistics.avgMembersPerFamily}</p>
            </div>
        ...
        <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm font-medium text-gray-600 dark:text-gray-400">New Families (30d)</p>
              <p className="text-2xl font-bold text-gray-900 dark:text-white mt-1">{statistics.recentFamilies}</p>
            </div>
          ...
          <div className="flex gap-2">
            <button
              ...
              className={`px-4 py-2 rounded-lg border transition-colors ${
                sortBy === 'name' 
                  ? 'bg-emerald-100 dark:bg-emerald-900/20 border-emerald-500 text-emerald-700 dark:text-emerald-300' 
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 mb-6">
        {paginatedFamilies.map((family) => {
          ...
          return (
            <div key={family.id} className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 hover:shadow-md transition-shadow">
              <div className="p-6">
                <div className="flex items-start justify-between mb-4">
                  <div className="flex-1">
                    <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-1">{family.familyName}</h3>
                    <p className="text-sm text-gray-500 dark:text-gray-400">Created: {family.createdAt}</p>
                  </div>
                ...
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm font-medium text-gray-900 dark:text-white">{memberCount} Members</span>
                  </div>
                  {memberCount === 0 && (
                    <span className="px-2 py-1 text-xs font-medium text-orange-600 dark:text-orange-400 bg-orange-100 dark:bg-orange-900/20 rounded-full">
                      Empty
                    </span>
                  )}
                </div>
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    className="flex-1 flex items-center justify-center gap-2 px-3 py-2 text-sm font-medium text-emerald-600 dark:text-emerald-400 bg-emerald-50 dark:bg-emerald-900/20 rounded-lg hover:bg-emerald-100 dark:hover:bg-emerald-900/30 transition-colors"
                  >
      ...
      {filteredAndSortedFamilies.length === 0 && (
        <div className="text-center py-12">
          ...
          <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-2">No families found</h3>
